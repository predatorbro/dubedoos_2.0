...
import { CheckIcon, ChevronDownIcon, ChevronUpIcon, Palette } from "lucide-react"
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <Palette
          size={16}
          className="text-muted-foreground/80 md:hidden in-aria-invalid:text-destructive/80 shrink-0"
        />
      </SelectPrimitive.Icon>
      <SelectPrimitive.Icon asChild className="">
        <ChevronDownIcon
          size={16}
          className="text-muted-foreground/80 hidden md:block in-aria-invalid:text-destructive/80 shrink-0"
        />
      </SelectPrimitive.Icon>
    </SelectPrimitive.Trigger>
  )
