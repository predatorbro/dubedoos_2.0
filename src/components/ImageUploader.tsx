import { AlertCircleIcon, ImagePlusIcon, UploadIcon, XIcon } from "lucide-react"
        ...
        {files.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center px-4 py-3 text-center">
            <div
              ...
              aria-hidden="true"
            >
              <ImagePlusIcon className="size-4 opacity-60" />
            </div>
            <p className="mb-1.5 text-sm font-medium">Drop your images here</p>
            <p className="text-muted-foreground text-xs">
              SVG, PNG, JPG or GIF (max. {maxSizeMB}MB)
            </p>
            <Button variant="outline" className="mt-4 text-black dark:text-foreground" onClick={openFileDialog}>
